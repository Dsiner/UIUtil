...
import com.d.lib.ui.layout.convenientbanner.listener.CBPageChangeListener;
...
public class ConvenientBanner<T> extends LinearLayout {
    ...
    public ConvenientBanner(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.lib_ui_layout_ConvenientBanner);
        canLoop = a.getBoolean(R.styleable.lib_ui_layout_ConvenientBanner_lib_ui_layout_cb_canLoop, true);
        pointPadding = (int) (a.getDimension(R.styleable.lib_ui_layout_ConvenientBanner_lib_ui_layout_cb_ppadding, 0));
        cbLayout = a.getResourceId(R.styleable.lib_ui_layout_ConvenientBanner_lib_ui_layout_cb_layout, 0);
        a.recycle();
        init(context);
    }
    ...
    private void init(Context context) {
        ...
        if (cbLayout != 0) {
            ...
            hView = LayoutInflater.from(context).inflate(
                    R.layout.lib_ui_layout_cb_include, this, true);
        }
