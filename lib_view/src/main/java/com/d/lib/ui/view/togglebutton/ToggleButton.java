package com.d.lib.ui.view.togglebutton;
...
public class ToggleButton extends View {
    ...
    private void initTypedArray(Context context, AttributeSet attrs) {
        ...
        colorNormal = typedArray.getColor(R.styleable.lib_ui_view_ToggleButton_lib_ui_view_tbtn_colorNormal, Color.parseColor("#ffffff"));
        colorLight = typedArray.getColor(R.styleable.lib_ui_view_ToggleButton_lib_ui_view_tbtn_colorLight, Color.parseColor("#FF4081"));
        colorPadding = typedArray.getColor(R.styleable.lib_ui_view_ToggleButton_lib_ui_view_tbtn_colorPadding, Color.parseColor("#e3e4e5"));
        padding = (int) typedArray.getDimension(R.styleable.lib_ui_view_ToggleButton_lib_ui_view_tbtn_padding, 4);
        duration = typedArray.getInteger(R.styleable.lib_ui_view_ToggleButton_lib_ui_view_tbtn_duration, 0);
        typedArray.recycle();
    }
