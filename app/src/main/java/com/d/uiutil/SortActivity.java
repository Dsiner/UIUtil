...
import com.d.uiutil.sort.SideBar;
import com.d.uiutil.sort.SortAdapter;
import com.d.uiutil.sort.SortBean;
import com.d.uiutil.sort.SortUtil;
...
public class SortActivity extends AppCompatActivity {
    ...
    public List<SortBean> getDatas() {
        String[] arrays = getResources().getStringArray(R.array.date);
